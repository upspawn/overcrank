/**
 * Reads virtual-clock.js and inlines it into virtual-clock.ts as a string export.
 * Run after editing virtual-clock.js: bun scripts/inline-clock.ts
 */
...
const js = readFileSync(join(dir, 'virtual-clock.js'), 'utf-8')
...
console.log('Inlined virtual-clock.js → virtual-clock.ts')
